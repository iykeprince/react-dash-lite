                            ...
                            <div class="card card-bordered">
                                ...
                                <div class="nk-kycfm">
                                    ...
                                    <div class="nk-kycfm-content">
                                        ...
                                        <h6 class="title">To avoid delays when verifying account, Please make sure of the following:</h6>
                                        ...
                                        <div class="nk-kycfm-upload">
                                            <h6 class="title nk-kycfm-upload-title">Upload Your Copy Here</h6>
                                    ...
                                    <div class="nk-kycfm-footer">
                                        ...
                                        <div class="nk-kycfm-action pt-2">
                                            <button type="submit" class="btn btn-lg btn-primary">Process for Verification</button>
                                        </div>
                                    </div>
                                </div>
                                </form>
