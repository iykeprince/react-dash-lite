...
import { createKyc } from "../../redux/kyc/kyc.actions";
...
const KycFormPage = () => {
    ...
    const errorMessage = useSelector(state => state.kyc.errorMessage);
    const message = useSelector(state => state.kyc.message);
    ...
    const handleChange = e => {
        ...
        setKycObject({ ...kycObject, [e.target.name]: value })
    }
    ...
    const handleSubmit = e => {
        ...
        formData.append('idfile', selectedFile)

        const objectKeys = Object.keys(kycObject);
        objectKeys.forEach(key => {
            formData.append(key, kycObject[key]);
        })
                                    ...
                                    <div className="nk-kycfm">
                                        ...
                                        <div className="nk-kycfm-content">
                                            <div className="nk-kycfm-note">
                                                <em className="icon ni ni-info-fill" data-toggle="tooltip" data-placement="right" title="Tooltip on right"></em>
                                                ...
                                                <div className="col-md-6">
                                                    <div className="form-group">
                                                        ...
                                                        <div className="form-control-group">
                                                            <input type="text" className="form-control form-control-lg" name="firstName" value={kycObject.firstName} onChange={handleChange} required />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="col-md-6">
                                                    <div className="form-group">
                                                        ...
                                                        <div className="form-control-group">
                                                            <input type="text" className="form-control form-control-lg" name="lastName" value={kycObject.lastName} onChange={handleChange} required />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="col-md-6">
                                                    <div className="form-group">
                                                        ...
                                                        <div className="form-control-group">
                                                            <input type="text" className="form-control form-control-lg" name="email" value={kycObject.email} onChange={handleChange} required />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="col-md-6">
                                                    <div className="form-group">
                                                        ...
                                                        <div className="form-control-group">
                                                            <input type="tel" className="form-control form-control-lg" name="phoneNumber" value={kycObject.phoneNumber} onChange={handleChange} required />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="col-md-6">
                                                    <div className="form-group">
                                                        ...
                                                        <div className="form-control-group">
                                                            <input type="date" className="form-control form-control-lg date-picker-alt" name="dateOfBirth" value={kycObject.dateOfBirth} onChange={handleChange} required />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="col-md-6">
                                                    <div className="form-group">
                                                        <div className="form-label-group">
                                                            <label className="form-label">Telegram Username <span className="text-danger">*</span></label>
                                                        </div>
                                                        <div className="form-control-group">
                                                            <input type="text" className="form-control form-control-lg" name="telegramUsername" value={kycObject.telegramUsername} onChange={handleChange} required />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div className="row g-4">
                                                <div className="col-md-6">
                                                    <div className="form-group">
                                                        ...
                                                        <div className="form-control-group">
                                                            <input type="text" className="form-control form-control-lg" name="address1" value={kycObject.address1} onChange={handleChange} required />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="col-md-6">
                                                    <div className="form-group">
                                                        ...
                                                        <div className="form-control-group">
                                                            <input type="text" className="form-control form-control-lg" name="address2" value={kycObject.address2} onChange={handleChange} />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="col-md-6">
                                                    <div className="form-group">
                                                        ...
                                                        <div className="form-control-group">
                                                            <input type="text" className="form-control form-control-lg" name="city" value={kycObject.city} onChange={handleChange} required />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="col-md-6">
                                                    <div className="form-group">
                                                        ...
                                                        <div className="form-control-group">
                                                            <input type="text" className="form-control form-control-lg" name="state" value={kycObject.state} onChange={handleChange} required />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="col-md-6">
                                                    <div className="form-group">
                                                        ...
                                                        <div className="form-control-group">
                                                            <input type="text" className="form-control form-control-lg date-picker-alt" name="nationality" value={kycObject.nationality} onChange={handleChange} required />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="col-md-6">
                                                    <div className="form-group">
                                                        ...
                                                        <div className="form-control-group">
                                                            <input type="text" className="form-control form-control-lg" name="zipCode" value={kycObject.zipCode} onChange={handleChange} required />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div className="nk-kycfm-content">
                                            ...
                                            <ul className="nk-kycfm-control-list g-3">
                                                <li className="nk-kycfm-control-item">
                                                    <input className="nk-kycfm-control" type="radio" name="idProof" id="passport" value="Passport" onChange={handleChange} checked={kycObject.idProof === 'Passport'} />
                                                ...
                                                <li className="nk-kycfm-control-item">
                                                    <input className="nk-kycfm-control" type="radio" name="idProof" id="national-id" value="National ID" onChange={handleChange} checked={kycObject.idProof === 'National ID'} />
                                                ...
                                                <li className="nk-kycfm-control-item">
                                                    <input className="nk-kycfm-control" type="radio" name="idProof" id="driver-licence" value="Driving License" onChange={handleChange} checked={kycObject.idProof === 'Driving License'} />
                                            ...
                                            <h6 className="title">To avoid delays when verifying account, Please make sure of the following:</h6>
                                            ...
                                            <div className="nk-kycfm-upload">
                                                <h6 className="title nk-kycfm-upload-title">Upload Your Copy Here</h6>
                                                        ...
                                                        <div className="nk-kycfm-upload-box">
                                                            <div className="upload-zone">
                                                                <div className="dz-message" data-dz-message>
                                                                    ...
                                                                    <button type="button" className="btn btn-primary" onClick={handleFileSelect}>SELECT</button>
                                        ...
                                        <div className="nk-kycfm-footer">
                                            ...
                                            <div className="nk-kycfm-action pt-2">
                                                <button type="submit" className="btn btn-lg btn-primary" disabled={loading}>{!loading ? `Process for Verification` : `Please wait ...`}</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
