        ...
        <div className="nk-odr-col">
            <div className="nk-odr-info">
                <div className="nk-odr-badge">
                    {transaction.withdraw_id && <><span className="nk-odr-icon bg-success-dim text-success icon ni ni-arrow-down-left"></span>
                        <span className="nk-odr-icon text-secondary icon ni ni-wallet-fill"></span></>}
                    {transaction.depositor_id && <><span className="nk-odr-icon bg-danger-dim text-danger icon ni ni-arrow-up-right"></span>
                        <span className="nk-odr-icon text-secondary icon ni ni-wallet-fill"></span></>}
                    {transaction.transaction_id && <>
                        <span className={`nk-odr-icon ${transaction.transaction_type === 'DEPOSIT' ? 'bg-danger-dim text-danger icon ni ni-arrow-up-right' : 'bg-success-dim text-success icon ni ni-arrow-down-left'} `}></span>
                        <span className="nk-odr-icon text-secondary icon ni ni-wallet-fill"></span>
                        </>
                        }
        ...
        <div className="nk-odr-col nk-odr-col-amount">
            <div className="nk-odr-amount">
                ...
                {type === 'all' ?
                    ...
                    : <div className={`number-md text-s ${transaction.withdraw_id ? 'text-success' : 'text-danger'}`}>
